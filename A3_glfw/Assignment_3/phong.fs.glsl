...
void main()
{
    ...
    vec3 ambientvec0 = (Light0.La+Material.Ka)/2;
    vec3 diffusevec0 = (Light0.Intensity*(Material.Kd+Light0.Ld)/2)*diffuse0/flipper0;
    vec3 specularvec0 = ((Material.Ks+Light0.Ld)/2 * specular0/flipper0);
